...
function Menu() {
  ...
  return (
    <aside className="sticky top-0 col-span-1 h-screen bg-gray-100 pt-8">
      <div className=" sticky col-span-1 h-[100vh] px-4">
        ...
        <ul className="mt-8 text-xs text-gray-600">
          <li
            className={
              pathname === "/"
                ? " mb-2 flex rounded-full px-2 py-1 align-middle font-bold text-blue-700 underline"
                : "mb-2 flex px-2 py-1 align-middle "
            }
          >
            <Link
              href="/"
              className={
                pathname === "/" ? "flex align-middle" : "flex align-middle "
              }
            >
          ...
          >
            <Link href="/table" className="flex align-middle">
          ...
          <li
            className={
              pathname === "/analysis"
                ? " mb-2 flex rounded-full  px-2 py-1 align-middle text-blue-700"
                : "mb-2 flex px-2 py-1 align-middle "
            }
          >
            <Link href="/table" className="flex align-middle">
